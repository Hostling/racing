          ...
          <div class="masthead clearfix">
            <div class="inner">
              ...
              <ul class="nav masthead-nav">
                <li class="active"><a href="#">Дрифт</a></li>
                <li><a href="racing.php">Тайматак</a></li>
              </ul>
            </div>
          </div>
	 	...
	 	if(isset($_POST['reg'])){
				...
				mysqli_set_charset($connect, "utf8");
				   ...
				   $res = mysqli_fetch_row($result);
    				$maxid = $res[0];
    				$maxid = $maxid + 1; 			
				$result = $connect->query("INSERT INTO `drift` (id, fio, auto, city) VALUES(\"$maxid\",\"$fio\",\"$auto\",\"$city\");"); 	
	 			header('Location: drift.php');
	 	}
		?>	
